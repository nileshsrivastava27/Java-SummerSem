...
//1. Store the frequency of each character in the given string
//2. Check whether a palidrome string can be formed or not using the properties of palidrome string.
//3. If palindrome string cannot be ofrmed, return "NO"
//4. ELse we create three strings and then return frontstr+oddstr+rearstr.
...
//ear_str Contains half occurrences of all even occurring characters of string in reverse order of front_str.
...
class Lexicographical_palidrome {
